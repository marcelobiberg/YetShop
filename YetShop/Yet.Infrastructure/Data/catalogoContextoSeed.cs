...
namespace Yet.Infrastructure.Data
{
    ...
    public class CatalogoContextoSeed
    {
        ...
        static IEnumerable<CatalogoItem> ObterPreConfiguradoCatalogoItens()
        {
            ...
            {
                new CatalogoItem(2,2, "Camiseta .NET Bot Preta", ".NET Bot Preta", 39.5M,  "/imagens/catalogoItens/product-1.jpg"),
                new CatalogoItem(1,2, "Caneca .NET preto & branco", ".NET preto & branco", 8.50M, "/imagens/catalogoItens/product-2.jpg"),
                new CatalogoItem(2,5, "Camiseta Prism branca", "Prism branca", 49.9M,  "/imagens/catalogoItens/product-3.jpg"),
                new CatalogoItem(2,2, "Camiseta .NET Foundation", "Camiseta .NET Foundation", 59.90M, "/imagens/catalogoItens/product-4.jpg"),
                new CatalogoItem(2,2, "Camiseta .NET Azul", ".NET Azul", 12, "/imagens/catalogoItens/product-5.jpg"),
                new CatalogoItem(2,5, "Camiseta Roslyn Vermelha", "Roslyn Vermelha",  12, "/imagens/catalogoItens/product-6.jpg"),
                new CatalogoItem(2,5, "Camiseta Kudu Roza", "Kudu Rosa", 8.5M, "/imagens/catalogoItens/product-6.jpg"),
                new CatalogoItem(1,5, "Caneca Cup<T> Branca", "Cup<T> Branca", 12, "/imagens/catalogoItens/product-7.jpg"),
                new CatalogoItem(2,5, "Camiseta Prism White TShirt", "Prism White TShirt", 12, "/imagens/catalogoItens/product-8.jpg")
            };
        }
        #endregion
    }
